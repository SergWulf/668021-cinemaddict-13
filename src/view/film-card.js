...
import {runtimeToHourAndMinutes} from "../util";
...
const createFilmCardTemplate = (film, countComments) => {
  const filmRuntime = runtimeToHourAndMinutes(parseInt(film.runtime, 10));
  ...
  return `<article class="film-card" data-id="${film.id}">
          ...
          <p class="film-card__info">
            ...
            <span class="film-card__duration">${filmRuntime.hours}h ${filmRuntime.minutes}m</span>
